...
public class jogstartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogstart);
        final TextView View = (TextView) findViewById(R.id.message5);
        final Button Start = (Button) findViewById(R.id.start5);
        final Button Pause = (Button) findViewById(R.id.pause5);
        final Button Resume = (Button) findViewById(R.id.resume5);
        final Button Cancel = (Button) findViewById(R.id.cancel5);
