...
public class FitnessMap extends AppCompatActivity implements OnInfoWindowClickListener, OnMarkerClickListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private HashMap<Location, Float> _distanceTo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServicesAvailable()) {
            setContentView(R.layout.activity_main);   /********* change from activity_fitness to activity_main***********/
        }

        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment supportMapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map);
        supportMapFragment.getMapAsync(this); // once getMapAsync, onMapReady function call
...
//        setSupportActionbar(toolbar);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Profile) {
            startActivity(new Intent(FitnessMap.this,Profile.class));

        }else if (id == R.id.Activity_Log) {
            startActivity(new Intent(FitnessMap.this,activity_log.class));
        }else if (id == R.id.Setting) {
        }else if (id == R.id.Intelligence) {
        }else if (id == R.id.Fitness) {
        }else if (id == R.id.Society) {
            startActivity(new Intent(FitnessMap.this, activity_description.class));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mapTypeNone) {
            _googleMap.setMapType(GoogleMap.MAP_TYPE_NONE);
